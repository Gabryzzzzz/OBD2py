...
import { motore_prestazioni, MotorePrestazioniService } from 'src/app/Services/OBD_Handler/motore_prestazioni.service';
...
export class HomeComponent implements OnInit {
  ...
  handle_throttle() {
    if (this.obd_data != undefined) {
      // Calcola l'altezza in percentuale
      this.throttlePercentage = (this.obd_data!.acceleratore / this.maxThrottle) * 100;
